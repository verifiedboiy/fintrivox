...
export default function Withdraw() {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-center p-6 bg-white rounded-2xl border border-gray-100 shadow-sm max-w-2xl mx-auto mt-10">
        ...
        <p className="text-gray-500 mb-8 max-w-md">
          To ensure the security of your funds and comply with financial regulations, you must verify your identity before you can make a withdrawal.
        </p>
  ...
  const isKycVerified = true; // Still used for internal logic
